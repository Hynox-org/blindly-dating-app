...
class BootstrapService {
  ...
  Future<void> _refreshDataInBackground() async {
    try {
      ...
      final freshUsers = await _ref.read(discoveryFeedProvider.notifier).refreshFeed();
      ...
      print("⚠️ BOOTSTRAP: Network refresh failed ($e). App will continue in Offline Mode.");
  ...
  Future<void> _preCacheImages(List<DiscoveryUser> users) async {
    print("⬇️ PRE-CACHE: Starting background image download for ${users.length} profiles...");
    ...
    print("✅ PRE-CACHE: Successfully downloaded $count images for offline use.");
  }
}