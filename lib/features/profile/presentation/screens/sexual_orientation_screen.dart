...
class SexualOrientationScreen extends ConsumerStatefulWidget {
  ...
  const SexualOrientationScreen({super.key, this.isEditMode = false});
...
class _SexualOrientationScreenState
  ...
  void initState() {
    ...
    _selectedOption = profile?.sexualOrientation;
  }
  ...
  Future<void> _save() async {
    try {
      ...
      await repo.updateProfile(userId, {'sexual_orientation': _selectedOption});

      if (mounted) {
        final currentProfile = ref.read(currentUserProfileProvider).value;
        if (currentProfile != null) {
          final updatedProfile = currentProfile.copyWith(
            sexualOrientation: _selectedOption,
          );
          ref
