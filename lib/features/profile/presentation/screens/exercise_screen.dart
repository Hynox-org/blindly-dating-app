...
class ExerciseScreen extends ConsumerStatefulWidget {
  ...
  const ExerciseScreen({super.key, this.isEditMode = false});
...
class _ExerciseScreenState extends ConsumerState<ExerciseScreen> {
  ...
  void initState() {
    ...
    _selectedExercise = profile?.exercise;
  }
  ...
  Future<void> _save() async {
    try {
      ...
      await repo.updateProfile(userId, {'exercise': _selectedExercise});
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelected = _selectedExercise == option;
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      _selectedExercise = option;
                    });
                  },
                  child: Container(
