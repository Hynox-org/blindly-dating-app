...
class PhotoModerationRepository {
  // ⚠️ PASTE YOUR AWS URL HERE (The one ending in /moderate-photo)
  final String _apiUrl = "https://2v97f9v05m.execute-api.ap-south-1.amazonaws.com/prod/moderate-photo";
