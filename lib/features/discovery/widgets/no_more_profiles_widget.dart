...
import '../../discovery/povider/discovery_provider.dart';

class NoMoreProfilesWidget extends ConsumerStatefulWidget {
  const NoMoreProfilesWidget({super.key});

  @override
  ConsumerState<NoMoreProfilesWidget> createState() => _NoMoreProfilesWidgetState();
}
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.check_circle_outline, size: 80, color: Color(0xFFD4AF37)),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _isLoading 
                ...
                : const Text("Refresh Feed", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
            ),
          ),
          ...
          TextButton(
            ...
            child: const Text("Adjust Discovery Settings", style: TextStyle(color: Colors.grey)),
          )
        ],
      ),
    );
