...
class DiscoveryFeedNotifier extends StateNotifier<AsyncValue<List<DiscoveryUser>>> {
...
final discoveryFeedProvider = StateNotifierProvider<DiscoveryFeedNotifier, AsyncValue<List<DiscoveryUser>>>((ref) {
