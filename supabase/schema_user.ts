...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      matches: {
        Row: {
          ...
          unmatched_by_user_id: string | null
          user_a_id: string
          user_b_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "matches_unmatched_by_user_id_fkey"
            columns: ["unmatched_by_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      profile_mode_interestchips: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_mode_interestchips_chip_id_fkey"
            columns: ["chip_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "profile_mode_interestchips_profile_mode_id_fkey"
            columns: ["profile_mode_id"]
            isOneToOne: false
            referencedRelation: "profile_modes"
            referencedColumns: ["id"]
          },
        ]
      }
      profile_mode_lifestylechips: {
        Row: {
          chip_id: string
          created_at: string
          profile_mode_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "profile_mode_lifestylechips_chip_id_fkey"
            columns: ["chip_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "profile_mode_lifestylechips_profile_mode_id_fkey"
            columns: ["profile_mode_id"]
            isOneToOne: false
            referencedRelation: "profile_modes"
            referencedColumns: ["id"]
      ...
      profile_mode_media: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_mode_media_profile_mode_id_fkey"
            columns: ["profile_mode_id"]
            isOneToOne: false
            referencedRelation: "profile_modes"
            referencedColumns: ["id"]
      ...
      profile_mode_prompts: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_mode_prompts_profile_mode_id_fkey"
            columns: ["profile_mode_id"]
            isOneToOne: false
            referencedRelation: "profile_modes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "profile_mode_prompts_prompt_template_id_fkey"
      ...
      profile_modes: {
        Row: {
          ...
          id: string
          is_active: boolean
          mode: Database["public"]["Enums"]["profile_mode_enum"]
          profile_id: string
          updated_at: string
        }
        Insert: {
      ...
      profiles: {
        Row: {
          ...
          pronouns: Database["public"]["Enums"]["pronouns_enum"] | null
    ...
    Functions: {
      ...
      expire_matches: { Args: never; Returns: undefined }
      extend_match_expiry: { Args: { p_match_id: string }; Returns: undefined }
      get_daily_expiry_rate: { Args: { p_date: string }; Returns: Json }
      get_daily_match_analytics: { Args: { p_date: string }; Returns: Json }
      get_daily_match_rate: { Args: { p_date: string }; Returns: Json }
      get_daily_unmatch_rate: { Args: { p_date: string }; Returns: Json }
      ...
      record_swipe: {
        Args: { p_action_type: string; p_target_profile_id: string }
        Returns: Json
      }
      undo_last_swipe: { Args: never; Returns: Json }
      unmatch_users: { Args: { p_match_id: string }; Returns: undefined }
    ...
    Enums: {
      ...
      match_status_enum: "active" | "expired" | "unmatched"
      ...
      safety_flag_type:
        ...
        | "photo_manipulation"
        | "location_spoofing"
      swipe_action: "like" | "pass" | "super_like" | "rewind"
